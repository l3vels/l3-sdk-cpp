...
void AssetsResponseDto::validate()
{
    // TODO: implement validation
}

web::json::value AssetsResponseDto::toJson() const
{
...
bool AssetsResponseDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AssetsResponseDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetsResponseDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<Asset>>& AssetsResponseDto::getItems()
{
    return m_Items;
}

void AssetsResponseDto::setItems(const std::vector<std::shared_ptr<Asset>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool AssetsResponseDto::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void AssetsResponseDto::unsetItems()
{
    m_ItemsIsSet = false;
}
double AssetsResponseDto::getTotal() const
{
    return m_Total;
}

void AssetsResponseDto::setTotal(double value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool AssetsResponseDto::totalIsSet() const
{
    return m_TotalIsSet;
}

void AssetsResponseDto::unsetTotal()
{
    m_TotalIsSet = false;
}
double AssetsResponseDto::getLimit() const
{
    return m_Limit;
}

void AssetsResponseDto::setLimit(double value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}

bool AssetsResponseDto::limitIsSet() const
{
    return m_LimitIsSet;
}

void AssetsResponseDto::unsetLimit()
{
    m_LimitIsSet = false;
}
double AssetsResponseDto::getPage() const
{
    return m_Page;
}

void AssetsResponseDto::setPage(double value)
{
    m_Page = value;
    m_PageIsSet = true;
}

bool AssetsResponseDto::pageIsSet() const
{
    return m_PageIsSet;
}

void AssetsResponseDto::unsetPage()
{
    m_PageIsSet = false;
}
}
